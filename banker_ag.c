...
int *resources;      // available resources
int **allocated;     // allocated resources to processes 
int **maxRequired;   // maximum resource required for each process
int **need;          // remaining needed resources for each process
int *safeSeq;        // safe sequence of processes 
int nProcessRan = 0; // number of processes executed

pthread_mutex_t lockResources; // mutex lock for resources  
